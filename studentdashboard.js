...
function renderNotificationsTab(contentDiv) {
    contentDiv.innerHTML = `
        <h2 class="text-xl font-bold mb-4 text-blue-700">Notifications</h2>
        <ul class="space-y-4">
            <li class="bg-blue-50 p-4 rounded-lg shadow flex items-center gap-3 notification-item">
                <span class="text-2xl">🔔</span>
                <span>Your parcel PMS-87654 is ready for pickup at the Kutir office.</span>
            </li>
            <li class="bg-green-50 p-4 rounded-lg shadow flex items-center gap-3 notification-item">
                <span class="text-2xl">📦</span>
                <span>Parcel PMS-23456 has been delivered to your hostel.</span>
            </li>
        </ul>
    `;
}
