...
function addParcel() {
    ...
    result.innerHTML = `<div class='p-4 bg-green-50 rounded-lg'>Parcel <b>${orderId}</b> added for hostel <b>${hostelName}</b> on <b>${parcelDate}</b>.</div>`;
}
...
function updateParcelStatus() {
    ...
    result.innerHTML = `<div class='p-4 bg-yellow-50 rounded-lg'>Status for <b>${orderId}</b> updated to <b>${newStatus}</b>.</div>`;
}
